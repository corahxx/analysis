...
from handlers.data_utils import append_taiwan_placeholder_row
...
def build_highway_workbook_bytes(
    ...
    *,
    ...
    if province_df is not None and "省份" in province_df.columns:
        province_df = append_taiwan_placeholder_row(province_df, fill_value=pd.NA)
